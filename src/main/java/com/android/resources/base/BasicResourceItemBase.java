...
public abstract class BasicResourceItemBase implements BasicResourceItem {
  ...
  public final ResourceReference asReference() {
    return new ResourceReference(getNamespace(), getResourceType(), getName());
  }
  ...
  public boolean isFramework() {
    return getNamespace() == ResourceNamespace.ANDROID;
  }
  ...
  public String getKey() {
    final String qualifiers = getConfiguration().getQualifierString();
